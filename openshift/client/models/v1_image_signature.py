...
class V1ImageSignature(object):
    ...
    """
    def __init__(self, conditions=None, content=None, created=None, image_identity=None, issued_by=None, issued_to=None, metadata=None, signed_claims=None, type=None):
        """
