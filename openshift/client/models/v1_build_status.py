...
class V1BuildStatus(object):
    ...
    """
    def __init__(self, cancelled=None, completion_timestamp=None, config=None, duration=None, message=None, output_docker_image_reference=None, phase=None, reason=None, start_timestamp=None):
        """
