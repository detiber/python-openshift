...
class V1OAuthAccessToken(object):
    ...
    """
    def __init__(self, authorize_token=None, client_name=None, expires_in=None, metadata=None, redirect_uri=None, refresh_token=None, scopes=None, user_name=None, user_uid=None):
        """
