...
class V1OAuthClient(object):
    ...
    """
    def __init__(self, additional_secrets=None, grant_method=None, metadata=None, redirect_ur_is=None, respond_with_challenges=None, scope_restrictions=None, secret=None):
        """
